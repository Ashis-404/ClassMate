        ...
        <div className="bg-surface/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 p-8">
          ...
          >
            ...
            <motion.button
              ...
              type="submit"
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-gradient-to-r from-neon-purple to-neon-pink text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-neon-purple/25 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
            >
